...
def generate_centroid_region_2d(points: torch.Tensor, num_grid_points: int, grid_size_xz: List[float] = [1., 2.]):
...
def str2cls_arkit(s, return_type='one_hot'):
    str_list = [
        "cabinet",  # 0
        "refrigerator",  # 1
        "shelf",  # 2
    ...
    if s not in str_list:  # Return -1 for invalid entries
        return -1
