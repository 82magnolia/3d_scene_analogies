...
from threed_front.atiss_utils.common import BaseDataset
from threed_front.atiss_utils.threed_front_scene import Room
from threed_front.atiss_utils.utils import parse_threed_front_scenes
...
class ThreedFront(BaseDataset):
    ...
    def from_dataset_directory(cls, dataset_directory, path_to_model_info,
                               ...
                               path_to_bounds=None, filter_fn=lambda s: s, num_load_layout=-1):
